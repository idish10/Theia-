...
from pattrn_robust_tracking.loggers.osmo.staketaxcsv.common.ibc.protobuf_decoder import (
...
def get_txs_all(node, wallet_address, limit=TXS_LIMIT_PER_QUERY, debug=False,
                events_types=None):
    api = RpcAPI(node)
    api.debug = debug
    max_txs = 20000
