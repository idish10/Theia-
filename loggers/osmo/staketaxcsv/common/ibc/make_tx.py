from pattrn_robust_tracking.loggers.osmo.staketaxcsv.common.ExporterTypes import TX_TYPE_NOOP, TX_TYPE_STAKING, TX_TYPE_UNKNOWN
from pattrn_robust_tracking.loggers.osmo.staketaxcsv.common import make_tx
